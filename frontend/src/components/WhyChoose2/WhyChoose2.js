...
const WhyChoose2 = () => {
    ...
    const reasons = [
        {
            ...
            stats: { number: "400+", label: "Students Guided" },
        },
        {
            id: 2,
    ...
    const achievements = [
        { icon: <FaAward />, number: "3+", label: "Years of experience", color: "#ffffff" },
        { icon: <FaUsers />, number: "400+", label: "Students Counseled", color: "#ffffff" },
        { icon: <FaGraduationCap />, number: "40+", label: "University options", color: "#ffffff" },
        { icon: <FaGlobe />, number: "15+", label: "German Cities", color: "#ffffff" },
    ];
    ...
    return (
        <div className="why-choose2" id="why-choose">
            <div className="container why-container">
                {/* Title Section */}
                <div className="row title-row">
                    <div className="col-12 title-col">
                        <div className="section-header">
                            <span className="badge">Our Excellence</span>
